...
export default function Pricing() {
  ...
  const plansMap = [
    ...
    priceId: process.env.NODE_ENV === "development" ? "price_1QxRYSDE4yFiyefwdjN7Ls6j" : "",
    },
    {
    id: "pro",
    name: "Pro",
    ...
    price: "19.99",
    items: ["Unlimited Blog Posts",
    "Unlimited Transcriptions"],
    paymentLink:"https://buy.stripe.com/test_4gwcNE0nr2lY0Xm5kl",
    priceId: process.env.NODE_ENV === "development" ? "price_1QxRZ3DE4yFiyefwH0wiaI09" : "",
  },
    ];
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      >
                        Get Scriptify.Ai <ArrowRight size={18} />
                      </Link>
                    </Button>
                  </div>
                </div>
